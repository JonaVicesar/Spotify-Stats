  ...
  if (!likedTracks || !likedTracks.tracks || likedTracks.tracks.length === 0) {
    return (
      <div className="text-center py-5">
        ...
        <h5 className="text-muted">No hay canciones en "Me gusta" disponibles</h5>
      </div>
    );
  }
        ...
        <div className="card bg-dark border-secondary h-100">
          <div className="card-header bg-danger d-flex align-items-center py-3">
            ...
            <h6 className="mb-0 text-white fw-semibold">
              Esta fue la última canción que agregaste a tus "Me gusta"😎
            </h6>
          </div>
          <div className="card-body p-4">
            <div className="d-flex align-items-start gap-3">
              ...
              <div className="flex-shrink-0">
                <img 
                  src={lastLikedTrack.imageUrl || 'https://via.placeholder.com/80x80?text=No+Image'} 
              ...
              <div className="flex-grow-1 min-w-0">
                ...
                <div className="mb-3">
                  <div className="d-flex align-items-center gap-2 mb-2">
                    ...
                    <span className="text-white fw-semibold">
                      {lastLikedTrack.album}
                    </span>
                  </div>
                  <div className="d-flex align-items-center gap-2">
                    <i className="fas fa-calendar text-danger"></i>
                    <span className="text-white fw-semibold">
                      Agregada el {new Date(lastLikedTrack.addedAt).toLocaleDateString('es-ES', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric'
                      })}
                ...
                <div className="d-flex gap-2 flex-wrap">
                  <button
                    ...
                    onClick={() => console.log('Play track:', lastLikedTrack.id)}
                  >
                  ...
                  <button
                    ...
                    onClick={() => console.log('Add to playlist:', lastLikedTrack.id)}
                  >
                  ...
                  <button
                    ...
                    onClick={() => console.log('View album:', lastLikedTrack.id)}
                  >
